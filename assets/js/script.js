...
const I18N = {
  ...
  ar: {
    ...
    'about.p1': '<strong>مهندس برمجيات</strong> بتركيز على تطبيقات الجوّال، ولديّ أكثر من 4 سنوات في بناء تطبيقات ولوحات تحكم وخدمات خلفية في بيئة الإنتاج. أتنقّل بين iOS والويب والأنظمة الخلفية، وأحرص أن أُتقن كلًّا منها.',
    'about.p2': 'أطلقتُ تطبيقَين على App Store بـ Swift و SwiftUI — أحدهما تجاوز 5,000 مستخدم — إلى جانب منتجات متكاملة مثل <strong>Jamaatna</strong>، منصة مناسبات فيها دعوات رقمية أنيقة وتأكيد حضور بنقرة ولوحة حضور مباشرة. كما أبني لوحات تقارير بـ Next.js و TypeScript وخدمات مصغّرة بـ ASP.NET Core؛ ولديّ القدرة على التعامل مع المنتج بالكامل، من الواجهة حتى قاعدة البيانات.',
    'about.p3': 'لست من محبّي الحلول السريعة التي تنهار بعد شهر. أكتب الكود بطريقة تُمكّن أي مبرمج من صيانته إن تطلّب الأمر (وغالبًا أكون أنا)، وأستمتع فعلًا بمراجعات الكود، وأعتمد يوميًا على أدوات الذكاء الاصطناعي مثل Claude Code لأنجز أسرع دون التفريط في الجودة. دائمًا أتعلّم، دائمًا أبني، دائمًا أُطلق.',
