...
const I18N = {
  en: {
    ...
    'about.p1': "I'm a mobile-first software engineer with 5+ years shipping real apps, dashboards and backend services. iOS, web, backend — I move between all three and try to do each one well.",
    ...
    'about.p4': "What I really bring to a project is judgment, not just code. I'm number-oriented, and I want to understand the business behind a feature — what it's for and what it should move — before I build it. Most days the job is fixing the actual problem, not just writing more code.",
  ...
  ar: {
    ...
    'about.p1': '<strong>مهندس برمجيات</strong> بتركيز على الجوّال، ولديّ أكثر من 5 سنوات في بناء تطبيقات ولوحات تحكم وخدمات خلفية حقيقية. أتنقّل بين iOS والويب والأنظمة الخلفية، وأحرص أن أُتقن كلًّا منها.',
    ...
    'about.p4': 'ما أُضيفه فعليًا للمشروع هو الحُكم على الأمور، لا الكود وحده. أنا مهتمّ بالأرقام، وأحبّ أن أفهم الجانب التجاري خلف أي ميزة — لماذا وُجدت وما الذي يُفترض أن تُحقّقه — قبل أن أبنيها. غالبًا يكون العمل حلّ المشكلة الحقيقية، لا مجرّد كتابة مزيد من الكود.',
