...
const I18N = {
  en: {
    ...
    'about.p1': "I'm a mobile-first software engineer with 5+ years shipping real apps, dashboards and backend services end to end — from the database up to the screens people actually touch. iOS, web, backend — I move between all three and try to do each one well.",
    'about.p2': "Two of my apps are live on the App Store in Swift &amp; SwiftUI (one crossed 5,000 users), alongside fullstack work like <strong>Jamaatna</strong> — an events platform with digital invitations, one-tap RSVP and a live attendance dashboard. I've built products from the UI down to the database.",
    'about.p3': "I'd rather write code that still makes sense a year later than a quick fix that breaks in a month. I like a good code review, and I use Claude Code daily to move faster without getting sloppy.",
    'about.p4': "What I really bring to a project is judgment, not just code. I care as much about <em>why</em> we're building something and how it feels to use as the code itself, and I do my best work in the space between product, design and engineering. I'm number-oriented, and I want to understand the business behind a feature — what it's for and what it should move — before I build it. Most days the job is fixing the actual problem, not just writing more code.",
  ...
  ar: {
    ...
    'about.p1': '<strong>مهندس برمجيات</strong> بتركيز على الجوّال، ولديّ أكثر من 5 سنوات في بناء تطبيقات ولوحات تحكم وخدمات خلفية حقيقية من البداية للنهاية — من قاعدة البيانات حتى الشاشات التي يلمسها المستخدم. أتنقّل بين iOS والويب والأنظمة الخلفية، وأحرص أن أُتقن كلًّا منها.',
    'about.p2': 'لديّ تطبيقان على App Store بـ Swift و SwiftUI (أحدهما تجاوز 5,000 مستخدم)، إلى جانب أعمال متكاملة مثل <strong>Jamaatna</strong> — منصة مناسبات فيها دعوات رقمية وتأكيد حضور بنقرة ولوحة حضور مباشرة. بنيتُ منتجات من الواجهة حتى قاعدة البيانات.',
    'about.p3': 'أفضّل كودًا يبقى مفهومًا بعد سنة على حلٍّ سريع ينهار بعد شهر. أستمتع بمراجعات الكود، وأعتمد يوميًا على Claude Code لأنجز أسرع دون التفريط في الجودة.',
    'about.p4': 'ما أُضيفه فعليًا للمشروع هو الحُكم على الأمور، لا الكود وحده. يهمّني <em>لماذا</em> نبني الشيء وكيف يشعر المستخدم عند استخدامه بقدر ما يهمّني الكود نفسه، وأُبدع أكثر في المساحة بين المنتج والتصميم والهندسة. أنا مهتمّ بالأرقام، وأحبّ أن أفهم الجانب التجاري خلف أي ميزة — لماذا وُجدت وما الذي يُفترض أن تُحقّقه — قبل أن أبنيها. غالبًا يكون العمل حلّ المشكلة الحقيقية، لا مجرّد كتابة مزيد من الكود.',
